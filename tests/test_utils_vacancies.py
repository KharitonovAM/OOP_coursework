...
def test_creation_vacanci_object():
    '''Тест проверяет корректность создания объекта класса Vacancies'''

    test_vacancy = Vacancies('тестовая вакансия', 'adress', {'from':150000, 'to':300000}, 'http://myurl.com','daily')
...
def test_compare_jobs_by_from(vac1, vac2):
...
def test_compare_jobs2_by_to(vac2, vac3):
    '''Тестируем корректность функционала по сравнению двух работ по зарплате
...
def test_compare_jobs2_by_to(vac2):
...
def test_valifashion_vacansii_to_low_0():
    '''тестируем, что при инициализации объекта класса Vacansy
    происходит валидация данных'''

    test_vacancy = Vacancies('тестовая вакансия', 'adress', {'from': -1, 'to': 300000}, 'http://myurl.com', 'daily')
    assert test_vacancy.salary['from'] == 0

def test_valifashion_vacansii_from_is_apsend():
    '''тестируем, что при инициализации объекта класса Vacansy
    происходит валидация данных'''

    test_vacancy = Vacancies('тестовая вакансия', 'adress', {'to': 300000}, 'http://myurl.com', 'daily')
    assert test_vacancy.salary['from'] == 0


def test_valifashion_vacansii_from_not_digit():
    '''тестируем, что при инициализации объекта класса Vacansy
    происходит валидация данных'''
...
def test_valifashion_vacansii_to_low_from():
    '''тестируем, что при инициализации объекта класса Vacansy
    происходит валидация данных'''

    test_vacancy = Vacancies('тестовая вакансия', 'adress', {'from': 500000, 'to': 300000}, 'http://myurl.com', 'daily')
    assert test_vacancy.salary['from'] == 500000

def test_valifashion_vacansii_to_is_apsend():
    '''тестируем, что при инициализации объекта класса Vacansy
    происходит валидация данных'''

    test_vacancy = Vacancies('тестовая вакансия', 'adress', {'from': 300000}, 'http://myurl.com', 'daily')
...
def test_error_check_object_class(vac1):
